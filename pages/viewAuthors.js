...
const viewAuthor = (obj) => {
  ...
  const domString = `
    ...
    <button type="button" class="btn btn-info" id="update-author--${obj.firebaseKey}"><i class="fa fa-edit" aria-hidden="true"></i></button>
    <button type="button" class="btn btn-danger" id="delete-author-btn--${obj.firebaseKey}"><i class="fa fa-trash" aria-hidden="true"></i></button>
    <br/>
    <br/>
    <h2>Books</h2>
  `;
